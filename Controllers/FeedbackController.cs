...
namespace DaprDemoAPI.Controllers
{
    ...
    public class FeedbackController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("ping")]
        public IActionResult Ping([FromServices] DaprClient daprClient)
        {
            
            _logger.LogInformation("Ping OK");
            return Content("Ping OK");
        }
        ...
        /// <returns></returns>        
        [Topic("messagebus", "ReceiveFeedback")]
        [Route("ReceiveFeedback")]
        [HttpPost]
        public async Task<ActionResult<UserFeedback>> ReceiveFeedback(string FirstName)
        {
             _logger.LogInformation($"Feedback received {FirstName}");
            ...
            // var state = await daprClient.GetStateEntryAsync<UserFeedback>(StoreName, FirstName);
